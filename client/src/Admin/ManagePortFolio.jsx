...
import { Trash2, Eye, EyeOff, Loader2, AlertTriangle, SearchX, PlusCircle } from 'lucide-react';
...
function ManagePortfolio() {
    ...
    return (
        <>
            <Helmet>
                <title>Manage Portfolio | Techistha</title>
                <meta name="description" content="Manage your portfolio items on Techistha." />
            </Helmet>
