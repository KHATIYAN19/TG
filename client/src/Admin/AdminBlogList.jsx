...
import { Trash2, Eye, EyeOff, Edit, PlusCircle, RefreshCw, Loader2, AlertTriangle, ExternalLink, X, ShieldAlert } from 'lucide-react';
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {blogs.map((blog, index) => (
                                        <tr
                                            ...
                                            onClick={() => handleRowClick(blog.slug)} // Add onClick to the row
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-center">
                                                <div className="flex items-center justify-center space-x-3">
                                                    <button
                                                        onClick={(e) => handleTogglePublish(blog._id, blog.isPublished, e)} // Pass event
                                                    ...
                                                    <button
                                                        onClick={(e) => openDeleteModal(blog._id, blog.title, e)} // Pass event
                                                        title="Delete"
