...
const SubmitReviewPage = () => {
  ...
  if (!formStatus.validToken && !formStatus.submitting && !formStatus.success) {
    return (
      <div ref={pageRef} className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4 pt-16">
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex flex-col items-center justify-center p-4 pt-16 pb-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" name="name" value={formData.name} onChange={handleInputChange} disabled={formStatus.submitting}
                className={`w-full px-4 py-2.5 rounded-xl border-2 bg-gray-50 focus:bg-white focus:border-blue-500 transition-all duration-200 ${
          ...
          <div>
            ...
            <textarea name="clientFeedback" value={formData.clientFeedback} onChange={handleInputChange} disabled={formStatus.submitting}
              rows="4" className={`w-full px-4 py-2.5 rounded-xl border-2 bg-gray-50 focus:bg-white focus:border-blue-500 transition-all duration-200 ${
          ...
          <button type="submit" disabled={formStatus.submitting}
            className="w-full bg-blue-600 text-white py-2.5 rounded-lg font-medium hover:bg-blue-700 transition-all duration-200 disabled:opacity-75 disabled:cursor-not-allowed flex items-center justify-center">
