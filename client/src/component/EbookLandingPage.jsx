...
const chapters = [
  ...
  ["02", "Google ADK: What It Is & Where It Fits", "Understand ADK, the developer workflow, and the current Agents CLI."],
...
export default function EbookPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] text-slate-900">
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                ...
                >
                  ...
                  <span className="flex items-center gap-2">
                    <span className="text-blue-200 line-through">₹299</span>
                    <span>₹149</span>
                  </span>
                  <ArrowRight size={18} />
                </button>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-5 -right-6 rounded-2xl border border-slate-200 bg-white px-5 py-4 shadow-2xl sm:-right-8">
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    <span className="text-sm font-semibold text-slate-400 line-through">₹299</span>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
        <div className="grid items-center gap-14 lg:grid-cols-[.8fr_1.2fr]">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {[
              [Terminal, "Learn the core", "Understand agents, models, tools, sessions, state, memory and workflows."],
              [Code2, "Build with code", "Follow implementation-focused examples, commands and project structures."],
              [Layers3, "Connect systems", "Explore RAG, MCP, A2A, APIs, artifacts, multimodal inputs and model integrations."],
              [Rocket, "Ship responsibly", "Cover evaluation, tracing, guardrails, security, performance and deployment."],
            ].map(([Icon, title, text]) => (
      ...
      {/* CONTENTS */}
      <section id="contents" className="bg-[#07111f] py-24 text-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
...
# observability and deployment.`}</code>
      ...
      {/* PRICING + POLICY */}
      <section id="pricing" className="relative overflow-hidden bg-[#07111f] py-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-[1.2fr_.8fr]">
              ...
              <div className="border-t border-slate-200 bg-slate-50 p-8 sm:p-10 lg:border-l lg:border-t-0 lg:p-10">
                <div className="flex h-full flex-col justify-center">
                  <p className="text-sm font-semibold text-slate-500">Regular price</p>

                  <div className="mt-2 flex items-end gap-3">
                    <span className="text-2xl font-bold text-slate-400 line-through">₹299</span>
          ...
          <div className="mx-auto mt-6 max-w-4xl rounded-2xl border border-white/10 bg-white/[.04] px-6 py-5 text-center">
            ...
            <p className="mt-1 text-xs leading-5 text-slate-500">
              Due to the digital nature of this ebook, all purchases are final and
              non-refundable. Please review the contents and FAQ before purchasing.
            </p>
      ...
      <section className="border-t border-slate-200 bg-white px-6 py-20 text-center">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            <span className="text-xl font-bold text-slate-400 line-through">₹299</span>
            <span className="text-4xl font-black text-blue-600">₹149</span>
          </div>
